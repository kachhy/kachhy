...
* **Tetromino Solver:** A fast C++ based 8x8 Tetromino solver, supporting multithreading and designed with a number of optimizations from Bitboard representation to parity pruning. Users can quickly find one, or all solutions to various Tetromino puzzles. 
